...
public class CalculatingHandler  extends AbstractBaseHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if(det != null) {
			AbstratctMeasuringView cView = ViewUtils.showMeasuringView(CalculationView.ID, 
											  det, MeasuringType.CALCULATING);
