...
public class AddDetailHandler extends AbstractBaseHandler {

	public AddDetailHandler() {
		setEnabled(false);
	}
	@Override
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			...
			detail.setMatter(view.getMatter());
			detail.setDefaultMeasuring(MeasuringType.MATCHING);
			...
			builder.buildControlBar(new SaveDetailExecutor(detail), false);
			builder.run();
