...
public class UprightOuterFactory extends XViewerFactory  {
	public final static String NAMESPACE = "shrinkage.diametral.upright.outer.xviewer";
	...
	public static XViewerColumn maxHight = new XViewerColumn(NAMESPACE + 
																".maxDiametr", 
																"H max, ìì", 
																70, 
																SWT.LEFT, 
	...
	public UprightOuterFactory(boolean preview) {
		super(NAMESPACE);
